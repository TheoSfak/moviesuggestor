...
/**
 * My Watch Later Page
 * Display all movies in the user's watch later list
 */
...
$watchLaterMovies = $watchLaterRepo->getWatchLater($userId);
$count = count($watchLaterMovies);
...
<head>
    ...
    <title>Watch Later - Movie Suggestor</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="nav-links">
                ...
                <a href="my-favorites.php">❤️ Favorites</a>
        ...
        <div class="content">
            <?php if ($count > 0): ?>
                <div class="stats">
                    ...
                    <p style="font-size: 1.2em; margin-top: 10px;">You have <strong><?= $count ?></strong> movies to watch</p>
                </div>
                
                <div class="movies-grid">
                    <?php foreach ($watchLaterMovies as $movie): ?>
                        <div class="movie-card" data-tmdb-id="<?= htmlspecialchars($movie['tmdb_id']) ?>">
                            ...
                            <div class="movie-info">
                                ...
                                <div class="movie-actions">
                                    <button class="btn btn-remove" onclick="removeFromWatchLater(<?= $movie['tmdb_id'] ?>, this)">
                                        🗑️ Remove
                                    </button>
                                </div>
                        </div>
    ...
    <script>
        ...
        async function removeFromWatchLater(tmdbId, button) {
            if (!confirm('Remove this movie from your watch later list?')) {
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    ...
                    showMessage('Removed from watch later!');
                } else {
